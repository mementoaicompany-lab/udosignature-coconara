...
def render(route,p):
 ...
 navitems=[('','홈'),('udo-scooter/','스쿠터'),('udo-electric-car/','전기차'),('partners/','협력업체'),('udo/','우도 여행'),('udo-ferry/','배시간'),('faq/','Q&A'),('refund/','취소·환불'),('location/','오시는길'),('customer-guide/','예약 고객 안내')]
